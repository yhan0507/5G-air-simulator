...
./Graph1.sh "Throughputs (bps)" "Number of user" $7 $7_$8 PF_Y1_$8_$7.dat MLWDF_Y1_$8_$7.dat EXPPF_Y1_$8_$7.dat QLE_Y1_$8_$7.dat
...
echo Thoughputs $7 REPORT FINISHED!!
